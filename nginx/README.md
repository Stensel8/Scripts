...
sudo ./nginx_installer.ps1 install
sudo ./nginx_installer.ps1 verify
sudo ./nginx_installer.ps1 remove
```
...
```bash
ENABLE_HEADERS_MORE=0 sudo ./nginx_installer.ps1 install
ENABLE_ZSTD=0 sudo ./nginx_installer.sh install
CONFIRM=no sudo ./nginx_installer.ps1 install
```
